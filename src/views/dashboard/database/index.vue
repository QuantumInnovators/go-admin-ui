  ...
  data() {
    return {
      ...
      cards: [
        ...
        { titlename: '物种分类  ', description: 'Deposit data or manuscripts into NCBI databases', imgUrl: require('@/assets/logo/logo.png'), pageUrl: '/dashboard/taxonomy/index' },
        { titlename: '上传', description: 'Deposit data or manuscripts into NCBI databases', imgUrl: require('@/assets/logo/logo.png'), pageUrl: '/dashboard/database/update' },
        ...
        { titlename: 'DNA分析', description: 'Deposit data or manuscripts into NCBI databases', imgUrl: require('@/assets/logo/logo.png'), pageUrl: '/analysis/analysis_overview' }
      ],
      selectedOption: 'all',
      searchText: ''
    }
