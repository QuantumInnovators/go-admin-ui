  ...
  data() {
    return {
      ...
      cards: [
        ...
        { titlename: '裸藻门', imgUrl: require('@/assets/logo/logo.png'), buttonTitles: ['进入'], pageUrl: '/database/search_ncbi' },
        { titlename: '蓝藻门', imgUrl: require('@/assets/logo/logo.png'), buttonTitles: ['进入'], pageUrl: '/profile/index' },
        { titlename: '绿藻门', imgUrl: require('@/assets/logo/logo.png'), buttonTitles: ['进入'], pageUrl: '/profile/index' },
        { titlename: '硅藻门', imgUrl: require('@/assets/logo/logo.png'), buttonTitles: ['进入'], pageUrl: '/profile/index' },
        { titlename: '甲藻门', imgUrl: require('@/assets/logo/logo.png'), buttonTitles: ['进入'], pageUrl: '/profile/index' }
      ],
      cards_2: [
