    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table v-loading="loading" :data="typeList">
          ...
          <!-- <el-table-column label="项目总览" align="center" prop="dictName" :show-overflow-tooltip="true" /> -->
          <el-table-column label="项目概述" align="center" :show-overflow-tooltip="true">
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px" :close-on-click-modal="false">
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            <el-form-item label="项目名称" prop="dictName">
              <el-input v-model="form.dictName" placeholder="请输入项目名称" :disabled="isEdit" />
            </el-form-item>
            <!-- <el-form-item label="字典类型" prop="dictType">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        dictName: [
          { required: true, message: '项目总览不能为空', trigger: 'blur' }
        ],
        dictType: [
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有类型数据项?', '警告', {
        ...
        import('@/vendor/Export2Excel').then(excel => {
          const tHeader = ['字典编号', '项目总览', '字典类型', '状态', '备注']
